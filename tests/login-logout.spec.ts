...
test('OrangeHRM - Login and Logout', async ({ page }) => {
  ...
  // waitUntil: 'domcontentloaded' (instead of the default 'load') and a longer
  // timeout make this more tolerant of slower/different network conditions on
  // a CI runner vs. your local machine.
